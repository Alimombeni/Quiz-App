                        ...
                        <div className='card p-4' style={{background: '#3d3d3d', borderColor: '#646464'}}>
                            <div className='d-flex justify-content-between gap-md-3'>
                                ...
                                <h5 style={{
                                    ...
                                    width: '100px',
                                    textAlign: 'right'
                                }}>{quiz.indexOf(question) + 1} / {quiz?.length}</h5>
                            </div>
                            <div>
                            ...
                            {(questionIndex + 1) !== quiz.length
                                ?
                                <button className='btn py-2 w-100 mt-3 bg-primary text-light fw-bold' onClick={next}
                                        disabled={!selectAnswer}>next</button>
                                :
                                <button className='btn py-2 w-100 mt-3 bg-primary text-light fw-bold'
                                        onClick={showTheResult} disabled={!selectAnswer}>show result</button>
                            }
                        </div>
                    </div>
                </div>
